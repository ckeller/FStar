      ...
      FStar_List.existsb
        (fun uu___94_6496  ->
           ...
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____6500));
               pos = uu____6501; vars = uu____6502;_} when
  ...
  fun l  ->
    let uu____6516 =
      let uu____6519 =
        ...
        Tm_fvar uu____6520 in
      mk uu____6519 in
    uu____6516 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let t_tactic_unit: term' syntax =
  let uu____6543 =
    let uu____6544 =
      let uu____6545 = tabbrev FStar_Parser_Const.tactic_lid in
      mk_Tm_uinst uu____6545 [U_zero] in
    let uu____6546 = let uu____6547 = as_arg t_unit in [uu____6547] in
    mk_Tm_app uu____6544 uu____6546 in
  uu____6543 FStar_Pervasives_Native.None FStar_Range.dummyRange
let t_tac_unit: term' syntax =
  let uu____6552 =
    let uu____6553 =
      let uu____6554 = tabbrev FStar_Parser_Const.u_tac_lid in
      mk_Tm_uinst uu____6554 [U_zero] in
    let uu____6555 = let uu____6556 = as_arg t_unit in [uu____6556] in
...
let t_list_of: term -> term =
  fun t  ->
    let uu____6563 =
      let uu____6564 =
        let uu____6565 = tabbrev FStar_Parser_Const.list_lid in
...
let t_option_of: term -> term =
  fun t  ->
    let uu____6574 =
      let uu____6575 =
        let uu____6576 = tabbrev FStar_Parser_Const.option_lid in
        mk_Tm_uinst uu____6576 [U_zero] in
      let uu____6577 = let uu____6578 = as_arg t in [uu____6578] in
      mk_Tm_app uu____6575 uu____6577 in
    uu____6574 FStar_Pervasives_Native.None FStar_Range.dummyRange
