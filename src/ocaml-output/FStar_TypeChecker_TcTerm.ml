  ...
  fun env  ->
    let uu___93_5 = env in
    {
      ...
      FStar_TypeChecker_Env.tc_hooks =
        (uu___93_5.FStar_TypeChecker_Env.tc_hooks)
    }
let no_inst: FStar_TypeChecker_Env.env -> FStar_TypeChecker_Env.env =
  fun env  ->
    let uu___94_10 = env in
    {
      ...
      FStar_TypeChecker_Env.tc_hooks =
        (uu___94_10.FStar_TypeChecker_Env.tc_hooks)
    }
let mk_lex_list:
           ...
           | letrecs ->
               ...
               let env1 =
                 let uu___96_923 = env in
                 {
                   ...
                   FStar_TypeChecker_Env.tc_hooks =
                     (uu___96_923.FStar_TypeChecker_Env.tc_hooks)
                 } in
               let precedes =
        ...
        (let uu___98_1706 = env in
         {
           ...
           FStar_TypeChecker_Env.tc_hooks =
             (uu___98_1706.FStar_TypeChecker_Env.tc_hooks)
         }) e
    ...
    fun tau  ->
      let env1 =
        let uu___102_4922 = env in
        {
          ...
          FStar_TypeChecker_Env.tc_hooks =
            (uu___102_4922.FStar_TypeChecker_Env.tc_hooks)
        } in
    ...
    fun tau  ->
      let env1 =
        let uu___103_4926 = env in
        {
          ...
          FStar_TypeChecker_Env.tc_hooks =
            (uu___103_4926.FStar_TypeChecker_Env.tc_hooks)
        } in
                           ...
                           let mk_letrec_env envbody bs1 c =
                             ...
                             let envbody1 =
                               let uu___111_8068 = envbody in
                               {
                                 ...
                                 FStar_TypeChecker_Env.tc_hooks =
                                   (uu___111_8068.FStar_TypeChecker_Env.tc_hooks)
                               } in
                        ...
                        (let uu___113_8506 = envbody in
                         {
                           ...
                           FStar_TypeChecker_Env.tc_hooks =
                             (uu___113_8506.FStar_TypeChecker_Env.tc_hooks)
                         }) body1 in
                               ...
                               (let uu___114_8554 = envbody in
                                {
                                  ...
                                  FStar_TypeChecker_Env.tc_hooks =
                                    (uu___114_8554.FStar_TypeChecker_Env.tc_hooks)
                                }) c_opt uu____8542 in
                            ...
                            (let targ1 =
                             ...
                             let env2 =
                               let uu___117_10212 = env1 in
                               {
                                 ...
                                 FStar_TypeChecker_Env.tc_hooks =
                                   (uu___117_10212.FStar_TypeChecker_Env.tc_hooks)
                               } in
                             (let uu____10214 =
                                FStar_TypeChecker_Env.debug env2
                                  FStar_Options.High in
                         ...
                         | (env1,uu____11963) ->
                             let env11 =
                               let uu___118_11969 = env1 in
                               {
                                 ...
                                 FStar_TypeChecker_Env.tc_hooks =
                                   (uu___118_11969.FStar_TypeChecker_Env.tc_hooks)
                               } in
                             let expected_pat_t =
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          let env2 =
            let uu___120_13126 = env1 in
            {
              ...
              FStar_TypeChecker_Env.tc_hooks =
                (uu___120_13126.FStar_TypeChecker_Env.tc_hooks)
            } in
          let uu____13127 =
            let uu____13138 =
                                   ...
                                   (let uu___127_14069 = env0 in
                                    {
                                      ...
                                      FStar_TypeChecker_Env.tc_hooks =
                                        (uu___127_14069.FStar_TypeChecker_Env.tc_hooks)
                                    }) t uu____14057 in
                          ...
                          let env3 =
                            ...
                            then
                              let uu___128_14078 = env2 in
                              {
                                ...
                                FStar_TypeChecker_Env.tc_hooks =
                                  (uu___128_14078.FStar_TypeChecker_Env.tc_hooks)
                              }
                            else
                       ...
                       (let uu___130_14330 = env11 in
                        {
                          ...
                          FStar_TypeChecker_Env.tc_hooks =
                            (uu___130_14330.FStar_TypeChecker_Env.tc_hooks)
                        }) e11 in
    ...
    fun e  ->
      ...
      (let env1 =
         let uu___132_15207 = env in
         {
           ...
           FStar_TypeChecker_Env.tc_hooks =
             (uu___132_15207.FStar_TypeChecker_Env.tc_hooks)
         } in
       let uu____15212 =
                 ...
                 | (t_u,u) ->
                     let env1 =
                       let uu___135_15358 = env in
                       {
                         ...
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___135_15358.FStar_TypeChecker_Env.tc_hooks)
                       } in
                 ...
                 | (env1,uu____16313) ->
                     let env2 =
                       let uu___136_16319 = env1 in
                       {
                         ...
                         FStar_TypeChecker_Env.tc_hooks =
                           (uu___136_16319.FStar_TypeChecker_Env.tc_hooks)
                       } in
                     ((let uu____16321 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug env2)
