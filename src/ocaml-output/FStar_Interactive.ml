...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___196_1789  ->
    match uu___196_1789 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___197_1795  ->
    match uu___197_1795 with
    ...
    then
      ...
      (match st.repl_stack with
       ...
       | (env,curmod)::stack ->
           (pop st.repl_env "#pop";
            (let st' =
               let uu___212_3869 = st in
               {
                 repl_line = (uu___212_3869.repl_line);
                 repl_column = (uu___212_3869.repl_column);
                 repl_fname = (uu___212_3869.repl_fname);
                 repl_stack = stack;
                 repl_curmod = curmod;
                 repl_env = env;
                 repl_ts = (uu___212_3869.repl_ts);
                 repl_stdin = (uu___212_3869.repl_stdin)
               } in
              ...
              | (stack,env,ts) ->
                  ...
                  (match uu____3953 with
                   | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
                       ...
                       (FStar_Errors.clear ();
                        (let st' =
                           let uu___213_4065 = st in
                           {
                             repl_line = line;
                             repl_column = column;
                             repl_fname = (uu___213_4065.repl_fname);
                             repl_stack = stack2;
                             repl_curmod = (uu___213_4065.repl_curmod);
                             repl_env = (uu___213_4065.repl_env);
                             repl_ts = ts1;
                             repl_stdin = (uu___213_4065.repl_stdin)
                           } in
                         match res with
                         | FStar_Pervasives_Native.Some (curmod,env3,nerrs)
                             ...
                             ((QueryOK, (FStar_Util.JsonList errors)),
                               (FStar_Util.Inl
                                  (let uu___214_4119 = st' in
                                   {
                                     repl_line = (uu___214_4119.repl_line);
                                     repl_column =
                                       (uu___214_4119.repl_column);
                                     repl_fname = (uu___214_4119.repl_fname);
                                     repl_stack = (uu___214_4119.repl_stack);
                                     repl_curmod = curmod;
                                     repl_env = env4;
                                     repl_ts = (uu___214_4119.repl_ts);
                                     repl_stdin = (uu___214_4119.repl_stdin)
                                   })))
                         | uu____4120 ->
                             let env3 = reset_mark env_mark in
                             let uu____4140 =
                               run_pop
                                 (let uu___215_4154 = st' in
                                  {
                                    repl_line = (uu___215_4154.repl_line);
                                    repl_column = (uu___215_4154.repl_column);
                                    repl_fname = (uu___215_4154.repl_fname);
                                    repl_stack = (uu___215_4154.repl_stack);
                                    repl_curmod = (uu___215_4154.repl_curmod);
                                    repl_env = env3;
                                    repl_ts = (uu___215_4154.repl_ts);
                                    repl_stdin = (uu___215_4154.repl_stdin)
                                  }) in
    ...
    fun term  ->
      fun rules  ->
        let run_and_rewind st1 task =
          ...
          let st' =
            let uu___216_5901 = st1 in
            {
              repl_line = (uu___216_5901.repl_line);
              repl_column = (uu___216_5901.repl_column);
              repl_fname = (uu___216_5901.repl_fname);
              repl_stack = (uu___216_5901.repl_stack);
              repl_curmod = (uu___216_5901.repl_curmod);
              repl_env = env;
              repl_ts = (uu___216_5901.repl_ts);
              repl_stdin = (uu___216_5901.repl_stdin)
            } in
